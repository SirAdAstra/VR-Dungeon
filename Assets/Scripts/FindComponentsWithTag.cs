...
public static class FindComponentsWithTag
{
    public static T[] FindComponentsInChildrenWithTag<T>(this Transform parent, string tag, bool forceActive = false) where T : Component
        {
